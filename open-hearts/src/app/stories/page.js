...
export default function Stories() {
    ...
    return (
        <div className="w-full min-h-screen flex flex-col items-center justify-between">
            <Header />
            <section className="w-full flex flex-col items-center mt-20 mb-40 px-6 sm:px-10 md:px-16 lg:px-24 xl:px-32 gap-8">
                <motion.div
                    className="w-full h-full border-t-4 border-b-4 border-[#A30B37] flex flex-col py-12 px-6 md:px-12 justify-center items-center gap-4"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
